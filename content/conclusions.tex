...
The aerospace engineering idea of a test stand is a facility, which allows the user to design experiments for the engine evaluation and to collect the results of the experiment executions. 
