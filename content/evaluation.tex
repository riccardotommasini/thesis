...
\cline{3-18}
                                                                                  &                                                              & \multicolumn{4}{c|}{GN}                                                          & \multicolumn{4}{c|}{GI}                                                          & \multicolumn{4}{c|}{TN}                                                          & \multicolumn{4}{c|}{TI}                                                                  \\ \cline{3-18} 
                                                                                  &                                                              & \multicolumn{2}{c|}{L} & \multicolumn{2}{c|}{M}                                  & \multicolumn{2}{c|}{L} & \multicolumn{2}{c|}{M}                                  & \multicolumn{2}{c|}{L} & \multicolumn{2}{c|}{M}                                  & \multicolumn{2}{c|}{L}         & \multicolumn{2}{c|}{M}                                  \\ \hline
\multicolumn{1}{|l|}{\begin{tabular}[c]{@{}l@{}}CTEvent\\ Init Size\end{tabular}} & \begin{tabular}[c]{@{}l@{}}CTEvent\\ Final Size\end{tabular} & AS         & PS        & \multicolumn{1}{l|}{AS}    & PS                         & AS         & PS        & AS                         & PS                         & AS         & PS        & \multicolumn{1}{l|}{AS}    & PS                         & AS  & \multicolumn{1}{l|}{PS}  & AS                         & PS                         \\ \hline
\multicolumn{1}{|l|}{10}                                                          & 100                                                          & Yes        & Yes       & \multicolumn{1}{l|}{Yes}   & \cellcolor[HTML]{656565}No & Yes        & Yes       & \cellcolor[HTML]{9B9B9B}No & \cellcolor[HTML]{9B9B9B}No & Yes        & Yes       & \multicolumn{1}{l|}{Yes}   & \cellcolor[HTML]{9B9B9B}No & Yes & \multicolumn{1}{l|}{Yes} & Yes                        & \cellcolor[HTML]{9B9B9B}No \\ \hline
