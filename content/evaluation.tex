...
\begin{figure}[tbh]
  \centering
  \subfigure[TI Step Response vs SOAK Tests - \textsc{CTEvent} Init Size = 10 Final Size 100 Num.Slots = 10]{
	\includegraphics[width=\linewidth]{images/step_lat_incremental_triple_soak_init_7soak_final_8step_101}
	}
\subfigure[GI Step Response vs SOAK Tests - \textsc{CTEvent} Init Size = 10 Final Size 100 Num.Slots = 10]{
