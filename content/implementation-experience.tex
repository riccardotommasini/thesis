...
\caption[\textsc{Analyser} Investigation Stack - Level 3 - Visual Comparison Examples]{\textsc{Analyser} Investigation Stack - Level 3 -  Examples visual comparison: Figure (a) shows an case of \textit{Inter Experiment} comparison presenting the relation between memory usage in two experiments; Figure (a) shows (b) an case of \textit{Intra Experiment} comparison displaying the latency and memory relation.}
