...
\begin{enumerate}
\item[R.1] \textit{Test data}, relevant RDF Streams and ontologies chosen from user's domain of interest. %R.2.1
...
\item[R.13] It must be Elementary: requiring the minimum design effort and being a naive solution without focusing on performances.  % non devono essere soluzioni smart, devono chiedere il minimo effort
