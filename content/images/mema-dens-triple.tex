\begin{table}[htbp]
	...
	\caption[\textsc{Analyser} Investigation Stack - Level 2 - Pattern Identification - Memory Distribution - Baselines TN and TI]{	Figure shows how memory values for TN (a) and TI (b) are distributed over ten intervals between the global  minimum and maximum of all the SOAK tests results}å
