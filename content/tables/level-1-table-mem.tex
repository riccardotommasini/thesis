...
\begin{table}[tbh]
	...
	\caption[\textsc{Analyser} Investigation Stack - Level 1 - SOAK Test Average Memory Comparison]{\textsc{Analyser} Investigation Stack - Level 1 - SOAK Test average memory comparison trough a qualitative approach.The following convention indicates the baseline has not reached the Steady State Condition:
