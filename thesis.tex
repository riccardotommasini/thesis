\documentclass[12pt,a4paper,twoside,openright,table,xcdraw]{report}
...
\usepackage{subfigure}
\usepackage[margin=12pt,font=small,labelfont=bf,
...
\makeatother
%------------------------------------------------------
% Remove space between chapters in LOF and LOT
%------------------------------------------------------
...
\input{content/problem-settings}
...
\input{content/implementation-experience}
